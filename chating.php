...
<div class="row-fluid" id='div_name'>
	...
	姓名:<? echo $_COOKIE["user"]; ?><input type=text class="inputtext bg" size=8 id='chat_user' value='' />
	...
	<div class="row" id='div_word'>
		...
		<div class="col-ms">
			<input type="button" class="btn btn-primary" value='发送' onClick="chat_send();$('chat_word').style.height=20;" onFocus="this.blur();"/>
		</div>
		<div class="col-ms">
		&nbsp;
		</div>
